    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Normal User'), ('member', 'Company Member'), ('admin', 'Admin')], default='user', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_doc', models.FileField(blank=True, null=True, upload_to='verifications/business/')),
